...
<link rel="stylesheet" href="/css/kakaomaps.css">
...
<body>
    ...
    <div id="divScheduleCreate">
        <button id="scheduleCreate"><h7>일정생성</h7></button>
    </div>
    <div id="rightSideBar">
        <div id="divSearch">
            <input type="text" placeholder="업체명을 입력하세요." id="searchInput"><button id="search"></button>
        </div>
        <div class="rightSelect rightRadioCss">
            <input type="radio" id="lodging" name="select" onclick="rightRadio(this)">
            <label for="lodging" style="width:100%;">
                <span>숙박</span>
            </label>
            <input type="radio" id="place" name="select" onclick="rightRadio(this)">
            <label for="place" style="width:100%; height: 20px;">
                <span>명소</span>
            </label>
            <input type="hidden" id="rightRadioCurrentP" value="2">
        </div>
        <div id="sectionTitle">
            <span>추천장소</span>
        </div>
        ...
        <input type="hidden" id="placeListCount" value="1">
    </div>
    <div id="leftSideBar">
        <div id="leftTop">
            <div id="cityName">
            ...
            <div id="divCalender">
                <input type="text" class="calender" id="startDate">
                ~
                <input type="text" class="calender" id="endDate">
            </div>
        </div>
        <div id="selectList">
            선택목록
        ...
        <div class="leftSelect leftRaidoCss">
            <input type="radio" id="lodgingSelect" name="leftSelect" onclick="leftRadio(this)">
            <label for="lodgingSelect" style="width:100%;">
                <span>숙박</span>
            </label>
            <input type="radio" id="placeSelect" name="leftSelect" onclick="leftRadio(this)">
            <label for="placeSelect" style="width:100%;">
                <span>명소</span>
            </label>
            <input type="hidden" id="leftRadioCurrentP" value="2">
        </div>
