...
<table>
	...
	<tr>		
		<td>업체명</td>
		<td><input type=text name=name id=name value="${p.place_name}" required></td>
	...
	<tr>		
		<td>전화</td>
		<td><input type=text name=tel id=tel value="${p.place_tel}" required></td>		
	</tr>
	<tr>		
		<td>영업시간</td>
		<td><input type=text name=open id=open value="${p.place_open}" required></td>		
	</tr>
	<tr>		
		<td>설명</td>
		<td><textarea name=content id=content required>${p.place_content}</textarea></td>		
	</tr>
	<tr>
      <td>이미지</td>
      <td>
...
.ready(function() {	
	$('#city').val('0'+'${p.city_num}').prop('selected', true);
	categoryChange();
	$('#place').val('${p.place_category_num}').prop('selected', true);
	//console.log(${p.city_num});
	//console.log(${p.place_category_num});
